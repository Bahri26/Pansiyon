...
namespace Pansiyon_Otomasyonu
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            MessageBox.Show("Kırmızı renkli butonlar dolu oddaları gösterir");
        }
        ...
        private void DaTCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            int Ucret;
            DateTime KucukTarih = Convert.ToDateTime(DaTGirisTarihi.Text);
            DateTime BuyukTarih = Convert.ToDateTime(DaTCikisTarihi.Text);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into MusteriEkle (Adi,Soyadi,Cinsiyet,Telefon,Mail,TC,OdaNo,Ucret,GirisTarihi,CikisTarihi) values ('"+TxtAdi.Text+"','"+TxtSoyadi.Text+"','"+CmdCinsiyet.Text+"','"+MskTxtTelefon.Text+ "','" +TxtMail+ "','" +TxtTCKimlikNo.Text+ "','" +TxtOdaNumarasi.Text+ "','" +TxtUcret.Text+ "','" +DaTGirisTarihi.Value.ToString("yyyy-MM-dd")+ "','" +DaTCikisTarihi.Value.ToString("yyyy-MM-dd") + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
